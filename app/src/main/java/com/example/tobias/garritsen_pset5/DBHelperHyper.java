...
/**
 * Created by Tobias on 15-5-2017.
 */
...
public class DBHelperHyper extends SQLiteOpenHelper {

    private static final String DATABASE_NAME = "ToDoHyperDB.db";
    ...
    // From mprog videos
    public DBHelperHyper (Context context) {
